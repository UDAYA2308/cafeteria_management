...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { menu_item_id: @order_detail.menu_item_id, menu_item_name: @order_detail.menu_item_name, menu_price: @order_detail.menu_price, order_id: @order_detail.order_id, quantity: @order_detail.quantity, total: @order_detail.total } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { menu_item_id: @order_detail.menu_item_id, menu_item_name: @order_detail.menu_item_name, menu_price: @order_detail.menu_price, order_id: @order_detail.order_id, quantity: @order_detail.quantity, total: @order_detail.total } }
